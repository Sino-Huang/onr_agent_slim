...
2. Compare the evidence with the versioned Mission Specification, current plan reference, scene/belief, lifecycle, and FSM execution artifacts.
...
4. Preserve the active frozen mission authority and plan while replanning is evaluated.
...
- Never perform a hidden local rewrite of the Mission Specification, plan, scene/belief, lifecycle, or FSM execution state.
